...
| 30 | **Desain Label (Studio)** | `/label-designer` | Normal | Normal | **Menu Baru**: Visual studio template barcode ala Open Label (diagram pita roll, caliper dimensi mm, 1-4 kolom, bentuk persegi/bulat/oval, kalkulator lebar kertas, serta **Direct Print via Bluetooth format TSPL** tanpa mengganggu menu barcode lama). |
