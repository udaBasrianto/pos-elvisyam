...
import { 
  ...
  Phone, Mail, MapPin, MessageCircle, Leaf
} from 'lucide-react';
...
export const StoreHome = () => {
  ...
  return (
    ...
    >
      {/* Dynamic SEO & OpenGraph Structured Data */}
      <StoreSeoHead
        title={shopInfo.business_name ? `${shopInfo.business_name} - Belanja Online Resmi` : 'Toko Online'}
        description={shopInfo.description || `${shopInfo.business_name || 'Toko kami'} - ${shopInfo.tagline || 'Pemesanan dan belanja online praktis, cepat, dan terpercaya'}.`}
        image={shopInfo.logo_url || shopInfo.business_logo}
          ...
          <div className="flex items-end justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground font-medium">
                Pilihan produk terbaik dan berkualitas untuk memenuhi kebutuhan Anda
              </p>
            </div>
            ...
            <div className="md:col-span-5 space-y-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground">{shopInfo.tagline || 'Pilihan Produk Terbaik'}</p>
                </div>
              </div>
